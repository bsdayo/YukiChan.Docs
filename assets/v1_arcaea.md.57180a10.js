import{_ as s,c as a,o as n,Q as e}from"./chunks/framework.e7dbb61d.js";const b=JSON.parse('{"title":"Arcaea - Arcaea 相关功能","description":"","frontmatter":{},"headers":[],"relativePath":"v1/arcaea.md","lastUpdated":1678805591000}'),l={name:"v1/arcaea.md"},p=e(`<div class="danger custom-block"><p class="custom-block-title">本页面已归档！</p><p>本页面为 v1 版本的旧文档，已经过时并停止更新。你可以前往<a href="./../v3/">暮雪酱 v3 文档</a>查看当前最新版本。</p></div><h1 id="arcaea-arcaea-相关功能" tabindex="-1">Arcaea - Arcaea 相关功能 <a class="header-anchor" href="#arcaea-arcaea-相关功能" aria-label="Permalink to &quot;Arcaea - Arcaea 相关功能&quot;">​</a></h1><h2 id="指令帮助" tabindex="-1">指令帮助 <a class="header-anchor" href="#指令帮助" aria-label="Permalink to &quot;指令帮助&quot;">​</a></h2><p><strong>注：暮雪酱的 Arcaea 功能尚未完全开发完成</strong></p><p>不同于 lancelot，暮雪对于 Arcaea 模块仅提供一种根指令：<code>#a</code>。</p><p>指令格式中，中括号 <code>[]</code> 中的内容为<strong>可选参数</strong>，尖括号 <code>&lt;&gt;</code> 中的内容为<strong>必选参数</strong>。</p><h3 id="a-bind-绑定-arcaea-账号" tabindex="-1">#a bind - 绑定 Arcaea 账号 <a class="header-anchor" href="#a-bind-绑定-arcaea-账号" aria-label="Permalink to &quot;#a bind - 绑定 Arcaea 账号&quot;">​</a></h3><p><strong>指令格式</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#a bind &lt;名称/好友代码&gt;</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span></code></pre></div><p><strong>备注</strong></p><p>若输入了起始难度但没有输入最高难度，则会在起始难度中随机抽取。</p><h2 id="常见问题" tabindex="-1">常见问题 <a class="header-anchor" href="#常见问题" aria-label="Permalink to &quot;常见问题&quot;">​</a></h2><h3 id="怎么没有-official-模式查分" tabindex="-1">怎么没有 official 模式查分？ <a class="header-anchor" href="#怎么没有-official-模式查分" aria-label="Permalink to &quot;怎么没有 official 模式查分？&quot;">​</a></h3><p>开发中，敬请期待</p>`,68),t=[p];function o(c,r,i,d,g,y){return n(),a("div",null,t)}const u=s(l,[["render",o]]);export{b as __pageData,u as default};
